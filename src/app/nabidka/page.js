  ...
  return (
    <div className="min-h-screen p-8 sm:p-20 flex flex-col items-center">
      ...
      <div className="lg:w-1/2 flex flex-col items-center space-y-4">
          <Image src="/klub.jpg" alt="Image 1" width={500} height={500} />
        </div>

        <div className="lg:w-1/2 flex flex-col items-center justify-center">
          <p className="text-center">
            Chceš se naučit tančit? Viděl si Star Dance a chtěl bys se naučit něco podobného?<br></br>Nebo jsi už tanečník a chceš se zlepšit? Přijď k nám do klubu, kde trénujeme latinskoamerické (Samba, Cha-cha, Rumba, Paso-doble, Jive) a standartní (Waltz, Valčík, Tango, Slowfox, Quickstep) tance.<br></br>Trénujeme děti a mládežníky od 6 do 18 let.<br></br> Zaujali jsme tě? Klikni a dozvíš se víc:
          </p>
      ...
      <div className="p-8 pb-20 sm:p-20 flex flex-col lg:flex-row">
        <div className="lg:w-1/2 flex flex-col items-center justify-center">
          ...
          <a className="mt-4 text-black bg-gray-200 rounded-full px-4 py-2 hover:bg-gray-300 hover:shadow-lg hover:shadow-[#cb3298]/50 transition duration-300">Kontakt</a>
          </Link>
        </div>
        <div className="lg:w-1/2 flex flex-col items-center space-y-4">
          <Image src="/vystoupeni.jpg" alt="Image 1" width={300} height={300} />
        </div>
      </div>
    </div>
  );
