    ...
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="p-8 pb-20 sm:p-20 flex flex-col lg:flex-row">
        <div className="lg:w-1/2 flex flex-col items-center justify-center">
          ...
          <a className="mt-4 text-black bg-gray-200 rounded-full px-4 py-2 hover:bg-gray-300 hover:shadow-lg hover:shadow-[#cb3298]/50 transition duration-300">Co nabízíme?</a>
          </Link>
        </div>
        <div className="lg:w-1/2 flex flex-col items-center space-y-4">
          <Image src="/treneri.png" alt="Image 1" width={300} height={300} />
        </div>
      </div>
    </div>
  );
