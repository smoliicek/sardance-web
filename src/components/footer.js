    ...
    return (
        <footer className="w-full bg-[#101010] text-white py-4 mt-auto">
            <div className="container mx-auto text-center">
                ...
                <p className='text-sm'>Stránka využívá pouze cookies nutné k jejímu správnému chodu. Created by <a className="text-blue-500" href="https://smoliicek.cz">Vít Smolík</a></p>
